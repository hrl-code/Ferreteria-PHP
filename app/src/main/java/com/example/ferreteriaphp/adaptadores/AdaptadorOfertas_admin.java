...
public class AdaptadorOfertas_admin extends RecyclerView.Adapter<AdaptadorOfertas_admin.ViewHolder> {

    private List<Articulo> listaOfertas;

    public AdaptadorOfertas_admin(List<Articulo> listaOfertas) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.itemofertas_admin, parent, false);
